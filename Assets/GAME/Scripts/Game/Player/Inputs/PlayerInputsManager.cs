...
public class PlayerInputsManager : MonoBehaviour
{
    ...
    public event Action OnPlayerChangedWeaponToSlotTwo;
    ...
    private void Awake()
    {
        ...
        _playerInputActions.PlayerWeaponsController.WeaponSlotThree.performed += _ => OnPlayerChangedWeaponToSlotTwo?.Invoke();
    }
